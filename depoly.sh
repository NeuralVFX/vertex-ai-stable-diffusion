...
PROJECT_ID="YOUR_GOOGLE_PROJET_NAME"
IMAGE_NAME="stable-diffusion"
REGION="us-central1"
SERVICE_ACCOUNT_ENDPOINT="vertex-stable-diffusion@YOUR_PROJECT_NAME.iam.gserviceaccount.com"

MODEL_DISPLAY_NAME="stable-diffusion:$TAG_VERSION"
ENDPOINT_NAME="stable_diffusion"
CONTAINER_IMAGE_URI="us.gcr.io/$PROJECT_ID/stable_diffusion:$TAG_VERSION"
