...
class DiffusersHandler(BaseHandler, ABC):
    ...
    def initialize(self, ctx):
        ...
        self.pipe = StableDiffusionPipeline.from_pretrained( "inference_model") #'inference_model
        self.pipe.to(self.device)
        logger.info("Diffusion model from path %s loaded successfully","inference_model")
